...
check($demoResult['eligible_count'] === 0 && $demoResult['non_field_borehole_count'] === 1, 'Non-field demo record excluded');
check($demoResult['exclusion_reasons']->non_field_demo_record === 1, 'Non-field exclusion reason');
$renamedDemo = fixture(5); $renamedDemo['borehole_code'] = 'BH-005'; $renamedDemo['soil_type'] = 'SYNTHETIC SAMPLE';
check($build([$renamedDemo])['eligible_count'] === 0, 'Renamed synthetic layer remains excluded by provenance');
